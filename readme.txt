...
Tags: ajax, attachments, image, picture, attach, detach, gallery, fancybox, gallery, photo, galleries, slider, slideshow, adwp, Gallery, thumbs gallery, photos, images, simple gallery, jquery, photo, thumbnails, thumbs, featured image, lightbox, slider, slide
Requires at least: 3.2.1
Tested up to: 3.4
Stable tag: 1.3

The Advanced Photo Gallery is a very simple wordpress plugin that embed a gallery anywhere on your site.
...
1. Upload ad-gallery folder to the `/wp-content/plugins/` directory
